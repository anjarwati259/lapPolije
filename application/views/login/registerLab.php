        ...
        <div class="col-lg-8 col-md-6 d-flex flex-column align-items-center justify-content-center">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              ...
              <form action="<?php echo base_url('login/AddregisterLab') ?>" method="POST" class="row g-3 needs-validation" novalidate>
                <div class="row">
                  <div class="col-6">
                  ...
                  <div class="col-6">
                    <label for="yourEmail" class="form-label">Unit Kerja</label>
